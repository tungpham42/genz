...
import {
  ...
  List,
  Typography,
  FloatButton, // Đảm bảo đã import FloatButton
  Spin,
  message,
  Tooltip, // Import thêm Tooltip để hiển thị chú thích khi hover
} from "antd";
import {
  ArrowUpOutlined,
  SearchOutlined,
...
const Dictionary: React.FC = () => {
  ...
  return (
    <Layout style={{ minHeight: "100vh", background: "transparent" }}>
      ...
      >
        <div
          style={{
            ...
            flexDirection: "column",
            alignItems: "center",
            // Đã xóa position: relative ở đây vì không còn nút absolute nữa
          }}
        >
          {/* ĐÃ XÓA BUTTON CŨ Ở ĐÂY ĐỂ HEADER GỌN GÀNG HƠN */}
      ...
      {/* Nút Game Gen Z: Đặt phía trên nút BackTop (bottom: 84) */}
      <Tooltip title="Thử thách Gen Z Game" placement="left">
        <FloatButton
          ...
          style={{
            right: 24,
            bottom: 84, // Cao hơn BackTop (thường là 24 + 50 + 10)
            width: 50,
            height: 50,
          }}
          // Style gradient cho nút nổi bật
          badge={{ dot: true, color: "#ff4d4f" }} // Thêm chấm đỏ để thu hút sự chú ý
          onClick={() => navigate("/game")} // Chuyển hướng sang trang Game
        />
      </Tooltip>

      {/* Nút Quay về đầu trang: Giữ nguyên ở góc phải dưới cùng */}
      <FloatButton.BackTop
